...
const Toast = ({ message, type = 'info', onClose, duration = 3000 }) => {
    ...
    return (
        <div className={`fixed bottom-5 right-5 z-50 flex items-center gap-3 px-4 py-3 rounded-xl border shadow-lg backdrop-blur-md animate-fade-in-up transition-all transform hover:-translate-y-1 ${bgColors[type] || bgColors.info}`}>
